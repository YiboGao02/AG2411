...
public class Game{
	...
	public static void main(String[] args) {
       ...
       //Layer valueLayer = new Layer(valueLayerName, valueLayerPath);
        ...
        String[] operations = {"localSum-zone", "localDifference-zone", "localProduct-zone", "localMean-zone", "localVariety-zone","localSum-value", "localDifference-value", "localProduct-value", "localMean-value", "localVariety-value"};
        //String[] operations = {"localSum-zone"};
        ...
        switch (chosenOperation) {
            ...
            case "localDifference-value":
                resultLayer = valueLayer.localDifference(zoneLayer, "Result - Local Difference-value");
                break;
